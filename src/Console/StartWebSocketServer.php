...
namespace Jonykpi\LaravelWebSockets\Console;

use Jonykpi\LaravelWebSockets\Facades\StatisticsLogger;
use Jonykpi\LaravelWebSockets\Facades\WebSocketsRouter;
use Jonykpi\LaravelWebSockets\Server\Logger\ConnectionLogger;
use Jonykpi\LaravelWebSockets\Server\Logger\HttpLogger;
use Jonykpi\LaravelWebSockets\Server\Logger\WebsocketsLogger;
use Jonykpi\LaravelWebSockets\Server\WebSocketServerFactory;
use Jonykpi\LaravelWebSockets\Statistics\DnsResolver;
...
class StartWebSocketServer extends Command
{
    ...
    protected function configureStatisticsLogger()
    {
        ...
        app()->singleton(StatisticsLoggerInterface::class, function ($app) use ($browser) {
            ...
            $class = $config['statistics']['logger'] ?? \Jonykpi\LaravelWebSockets\Statistics\Logger\HttpStatisticsLogger::class;
