    ...
    new Vue({
        ...
        methods: {
            ...
            subscribeToChannel(channel) {
                this.pusher.subscribe('{{ \Jonykpi\LaravelWebSockets\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX }}' + channel)
            ...
            subscribeToStatistics() {
                this.pusher.subscribe('{{ \Jonykpi\LaravelWebSockets\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX }}statistics')
